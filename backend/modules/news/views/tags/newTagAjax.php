...
<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-label="<?= Yii::t('b/news/tags', 'Close') ?>">
        <span aria-hidden="true">×</span></button>
    <h4 class="modal-title"><?= Yii::t('b/news/tags', 'Add new tag') ?></h4>
</div>
<div class="modal-body" id="newTagFromContainer">
    <?= $this->render('_form', ['model' => $model,]) ?>
</div>
<div class="modal-footer">
    <button type="button" class="btn btn-default pull-left" data-dismiss="modal"><?= Yii::t('b/news/tags', 'Close') ?></button>
</div>
