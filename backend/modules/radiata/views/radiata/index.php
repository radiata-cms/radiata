                            ...
                            <ul class="products-list product-list-in-box">
                                <li class="item">
                                    ...
                                    <div class="product-info">
                                        <a href="javascript::;" class="product-title">Samsung
                                            TV <span class="label label-warning pull-right">$1800</span></a>
                                ...
                                <li class="item">
                                    ...
                                    <div class="product-info">
                                        <a href="javascript::;" class="product-title">Xbox
                                            One <span class="label label-danger pull-right">$350</span></a>
                                            <span class="product-description">
                                ...
                                <li class="item">
                                    ...
                                    <div class="product-info">
                                        <a href="javascript::;" class="product-title">PlayStation
                                            4 <span class="label label-success pull-right">$399</span></a>
                                            <span class="product-description">
