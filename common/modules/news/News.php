            ...
            [
                ...
                'children'   => [
                    ...
                    [
                        ...
                        'isActiveUrlPart' => '/news/category/',
                    ],
                    [
                        'title'           => Yii::t('b/news/tag', 'Tags'),
                        'icon'            => 'fa fa-tags',
                        'link'            => Url::to(['/news/tag/index']),
                        'permission'      => \backend\modules\news\controllers\TagController::BACKEND_PERMISSION,
                        'isActiveUrlPart' => '/news/tag/',
                    ],
                ],
            ],
        ];
